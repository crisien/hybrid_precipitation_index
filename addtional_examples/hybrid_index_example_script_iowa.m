...
text(-11,-.32,'\tau = 10.101 months','color','r')
text(-11,-.44,'\alpha = 0.125','color','r')
text(-11,-.56,'\beta = 0.170','color','r')
title('Iowa Lagged Correlations','fontweight','normal')
